<x-navbar.base x-data="{ open: null }">
  ...
  @else
    <div class="col-start-5 col-span-2 hidden md:flex justify-start" @mouseenter="open = 'shelters-public'" @focusin="open = 'shelters-public'">
      <x-navbar.menu-item label="Menhelyek" :href="route('shelters.index')" />
    </div>

    <div class="col-start-9 col-span-2 hidden md:flex justify-start" @mouseenter="open = 'pets-public'" @focusin="open = 'pets-public'">
      <x-navbar.menu-item label="Kisállatok" href="#" />
    </div>

    <div class="col-start-11 col-span-2 hidden md:flex" @mouseenter="open = 'account'" @focusin="open = 'account'">
  ...
  <x-slot:dropdown>
    <div
      ...
      style="display: none;"
    >
      <div class="grid grid-cols-12 gap-8 px-6 lg:px-8 py-6">
        @if($isOwner)
          <div class="col-start-5 col-span-2 flex justify-start" x-show="open === 'shelter'" x-transition>
            <x-navbar.section title="Menhelyem">
              ...
              >Publikus oldal</x-navbar.link>
              <x-navbar.link
                :href="$ownShelter ? route('shelter.edit', $ownShelter) : '#'"
                class="text-white hover:text-black hover:font-bold"
              >Szerkesztés</x-navbar.link>
            </x-navbar.section>
          </div>

          <div class="col-start-9 col-span-2 flex justify-start" x-show="open === 'pets'" x-transition>
            <x-navbar.section title="Kisállatok">
              <x-navbar.link :href="url('/pets/create')" class="text-white hover:text-black hover:font-bold">Új kisállat</x-navbar.link>
              <x-navbar.link :href="url('/pets')" class="text-white hover:text-black hover:font-bold">Összes kisállat</x-navbar.link>
            </x-navbar.section>
          </div>

          <div class="col-start-11 col-span-2" x-show="open === 'staff'" x-transition>
            <x-navbar.section title="Munkatársak">
              <x-navbar.link :href="url('/staff')" class="text-white hover:text-black hover:font-bold">Kezelés</x-navbar.link>
              <x-navbar.account />
            </x-navbar.section>
          </div>
        @else
          <div class="col-start-5 col-span-2 flex justify-start" x-show="open === 'shelters-public'" x-transition>
            <x-navbar.section title="Menhelyek">
              <x-navbar.link :href="route('shelters.index')" class="text-white hover:text-black hover:font-bold">Összes menhely</x-navbar.link>
              <x-navbar.link href="#" class="text-white hover:text-black hover:font-bold">Debrecen</x-navbar.link>
              <x-navbar.link href="#" class="text-white hover:text-black hover:font-bold">Budapest</x-navbar.link>
            </x-navbar.section>
          </div>
          ...
          <div class="col-start-11 col-span-2" x-show="open === 'account'" x-transition>
